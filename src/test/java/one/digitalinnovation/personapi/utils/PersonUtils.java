...
public class PersonUtils {
    ...
    private static final String LAST_NAME = "Nobre";
    private static final String CPF_NUMBER = "822.863.425-04";
    private static final long PERSON_ID = 1L;
    public static final LocalDate BIRTH_DATE = LocalDate.of(1994, 03, 3);
